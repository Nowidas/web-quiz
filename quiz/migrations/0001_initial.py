    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pick', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quiz.choice')),
                ('test_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quiz.test_user')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='choice',
            name='picks',
            field=models.ManyToManyField(blank=True, null=True, through='quiz.ChoicePerUser', to='quiz.test_user'),
        ),
        migrations.AddField(
            model_name='choice',
            name='question',
